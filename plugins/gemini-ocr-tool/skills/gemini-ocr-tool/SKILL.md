...
**Usage:**
```bash
gemini-ocr-tool command-name ARGUMENT [OPTIONS]
```
...
```bash
# Example 1: Basic usage
gemini-ocr-tool command-name "example"

# Example 2: With options
gemini-ocr-tool command-name "example" --option value

# Example 3: Pipeline usage
gemini-ocr-tool command-name "example" --json | jq '.'
```
...
gemini-ocr-tool command -v

# DEBUG level - see detailed info
gemini-ocr-tool command -vv

# TRACE level - see all internals
gemini-ocr-tool command -vvv
```
...
gemini-ocr-tool command --json | jq '.'
```
...
- **GitHub**: https://github.com/dnvriend/gemini-ocr-tool
- **Python Package Index**: https://pypi.org/project/gemini-ocr-tool/
