...
- **Slash Commands**: Quick CLI invocations (e.g., `/gemini-ocr-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-gemini-ocr-tool`)
...
**File**: `plugins/gemini-ocr-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/gemini-ocr-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/gemini-ocr-tool/commands/<command>.md`
...
/gemini-ocr-tool:command "argument"
```

## Skills

**Location**: `plugins/gemini-ocr-tool/skills/gemini-ocr-tool/SKILL.md`
...
**Usage in Claude Code**:
```
/skill-gemini-ocr-tool
```

Or:
```
Use the skill-gemini-ocr-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/gemini-ocr-tool/commands/<command>.md`
...
3. `plugins/gemini-ocr-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/gemini-ocr-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/gemini-ocr-tool/commands/

# Check skill
cat plugins/gemini-ocr-tool/skills/gemini-ocr-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/gemini-ocr-tool:help`
3. Try skill: `/skill-gemini-ocr-tool`
