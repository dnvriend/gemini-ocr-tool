"""Completion command for gemini-ocr-tool.
...
def completion_command(shell: str) -> None:
    ...
    \b
    # Fish (add to ~/.config/fish/completions/gemini-ocr-tool.fish):
    ...
    if completion_class:
        completer = completion_class(
            ...
            ctx_args={},
            prog_name="gemini-ocr-tool",
            complete_var="_GEMINI_OCR_TOOL_COMPLETE",
        )
